...
from app.routers import clients, invoices, csv, pdf, drafts  # Importar las rutas de clientes y facturas
...
app.include_router(drafts.router)  # Incluir el router de facturas
